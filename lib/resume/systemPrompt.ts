...
- The summary is a positioning statement, not a biography. Do NOT enumerate past roles, count stints, or mention promotion velocity in the summary ("two Director roles", "three CTO stints", "two Director runs", "fastest promotion in company history"). Career-trajectory facts belong in the experience section where the dates make them credible. The summary stays on the three positioning facts (years, target shape, main capability cluster), full stop.
- No keyword stuffing.
